...
<form id="payment_form" action="payment_confirmation.php" method="post">
    ...
    <fieldset>  
        ...
        <span>transaction_type:</span><input type="text" name="transaction_type" value="sale,create_payment_token" size="25"><br/>
            <span>reference_number:</span><input type="text" name="reference_number" value="cptsale123" size="25"><br/>
            ...
            <span>Address Line1:</span><input type="text" name="bill_to_address_line1" value="2211"/><br/>
            <span>State:</span><input type="text" name="bill_to_address_state" value="TN"/><br/>
